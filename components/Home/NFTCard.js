...
const style = {
  wrapper: `bg-[#303339] relative flex h-[450px] w-[340px] cursor-pointer flex-col rounded-lg  shadow-lg transition-all duration-300 hover:shadow-2xl`, 
  ...
  nftTitle: `text-sm font-bold text-white`,
  priceContainer: `flex flex-col items-end justify-center space-y-1`,
  priceTitle: `text-xm font-light text-white`,
  priceValue: `text-white`,
